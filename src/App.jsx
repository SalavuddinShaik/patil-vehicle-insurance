...
export default function App() {
  ...
  return (
    <>
      <Nav />
      <Hero />
      <Categories onQuoteOpen={() => setQuoteOpen(true)} />
      <WhyChoose />
      <Commitment />
      <PolicyTypes />
      <ClaimAssistance />
      ...
      <a className="float-ig" href="https://www.instagram.com/patilvehicleinsurancesolution?igsh=MTgxNzJxMGFxNjUzdA==" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
      ...
      <a className="float" href="https://wa.me/919986330456" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
